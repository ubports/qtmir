...
TEST_F(QtEventFeederTest, GenerateMissingTouchEnd)
{
    ...
    auto ev1 = mev::make_event(MirInputDeviceId(), std::chrono::nanoseconds(123), 0 /* mac */, 0);
    ...
    auto ev2 = mev::make_event(MirInputDeviceId(), std::chrono::nanoseconds(125), 0 /* mac */, 0);
...
TEST_F(QtEventFeederTest, GenerateMissingTouchEnd2)
{
    ...
    auto ev2 = mev::make_event(MirInputDeviceId(), std::chrono::nanoseconds(124), 0 /* mac */, 0);
    ...
    auto ev3 = mev::make_event(MirInputDeviceId(), std::chrono::nanoseconds(125), 0 /* mac */, 0);
...
TEST_F(QtEventFeederTest, PressSameTouchTwice)
{
    ...
    auto ev2 = mev::make_event(MirInputDeviceId(), std::chrono::nanoseconds(123), 0 /* mac */, 0);
